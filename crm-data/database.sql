...
-- Generated: 2026-01-07T06:30:26.559Z
...
CREATE TABLE IF NOT EXISTS trips (id TEXT PRIMARY KEY, customerId TEXT, driverId TEXT, status TEXT, pickup TEXT, "drop" TEXT, dateTime TEXT, expectedStartDateTime TEXT, expectedEndDateTime TEXT, basePrice REAL, finalPrice REAL);
