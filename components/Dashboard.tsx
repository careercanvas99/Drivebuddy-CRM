...
const Dashboard: React.FC<DashboardProps> = ({ users, drivers, trips, customers, setTrips, setCustomers, currentUser }) => {
  ...
  const activeMissions = trips.filter(t => ['NEW', 'ASSIGNED', 'STARTED'].includes(t.status)).slice(0, 5);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="bg-gray-950 rounded-[2.5rem] border border-gray-900 p-8 space-y-6 shadow-2xl overflow-y-auto max-h-[300px]">
